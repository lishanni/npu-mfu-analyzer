...
def _generate_html_report(profiling_path: str, output: Optional[str], report: Any = None) -> Optional[Path]:
    ...
    from npu_mfu_analyzer.agents.operator_agent import FusionAnalyzer
    from datetime import datetime
...
def generate(
    ...
    from npu_mfu_analyzer.cli.aikg_workflow import AIKGWorkflow
...
def integrate(
    ...
    from npu_mfu_analyzer.cli.integration_workflow import IntegrationWorkflow
