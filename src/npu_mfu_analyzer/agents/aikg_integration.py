...
from npu_mfu_analyzer.agents.fusion_rules import FusionOpportunity, ASCEND_FUSED_OPERATORS
...
class AIKGRequestConverter:
    ...
    def _find_triton_hint(self, opportunity: FusionOpportunity) -> Optional[str]:
        ...
        from npu_mfu_analyzer.agents.fusion_rules import FUSION_PATTERNS
