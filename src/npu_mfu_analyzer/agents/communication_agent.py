...
from npu_mfu_analyzer.llm.prompts import COMMUNICATION_ANALYSIS_SYSTEM
from npu_mfu_analyzer.analyzers.comm_splitter import CommunicationSplitter, CommSplitResult, ParallelConfig
