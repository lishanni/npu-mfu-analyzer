...
from npu_mfu_analyzer.agents.timeline_agent import TimelineAgent
from npu_mfu_analyzer.agents.operator_agent import OperatorAgent
from npu_mfu_analyzer.agents.memory_agent import MemoryAgent
from npu_mfu_analyzer.agents.communication_agent import CommunicationAgent
from npu_mfu_analyzer.agents.jitter_agent import JitterAgent
from npu_mfu_analyzer.agents.advisor_agent import AdvisorAgent
from npu_mfu_analyzer.agents.detailed_operator_agent import DetailedOperatorAgent
from npu_mfu_analyzer.agents.detailed_operator_agent_v2 import DetailedOperatorAgentV2
from npu_mfu_analyzer.data_loader.profiling_loader import ProfilingLoader
from npu_mfu_analyzer.data_loader.data_summarizer import DataSummarizer, ProfilingSummary
from npu_mfu_analyzer.report.report_generator import ReportGenerator, ReportFormat
from npu_mfu_analyzer.analyzers.communication_matrix_analyzer import CommunicationMatrixAnalyzer, CommunicationMatrix
from npu_mfu_analyzer.agents.aic_microarch_agent import AICMicroarchAgent
...
from npu_mfu_analyzer.analyzers.operator_source_classifier import OperatorSourceClassifier
from npu_mfu_analyzer.analyzers.root_cause_engine import RootCauseSkillEngine, RootCauseFinding
from npu_mfu_analyzer.data_loader.stack_types import HostDeviceChain
...
""")
    ...
    def _calculate_mfu(self):
        """计算 MFU 指标"""
        try:
            from npu_mfu_analyzer.analyzers.mfu_calculator import MFUCalculator, ChipInfo, MFUMetrics
            import pandas as pd
    ...
    def _analyze_roofline(self):
        """执行 Roofline 分析"""
        try:
            from npu_mfu_analyzer.roofline.roofline_model import RooflineModeler, PrecisionType
    ...
    def _analyze_communication_matrix(self) -> Optional[CommunicationMatrix]:
        """执行通信矩阵分析"""
        try:
            from npu_mfu_analyzer.analyzers.communication_matrix_analyzer import CommunicationMatrixAnalyzer
    ...
    def _analyze_aic_microarchitecture(self) -> Optional[str]:
        """执行 AIC 微架构分析"""
        try:
            from npu_mfu_analyzer.data_loader.aic_metrics import analyze_aic_microarchitecture
            ...
            from npu_mfu_analyzer.data_loader.aic_metrics import load_aic_pmu_from_profiling
