...
from npu_mfu_analyzer.data_loader.profiling_loader import ProfilingLoader, ProfilingInfo
from npu_mfu_analyzer.data_loader.data_summarizer import DataSummarizer, ProfilingSummary
from npu_mfu_analyzer.data_loader.stack_types import HostDeviceChain, SourceAnalysisResult
...
class ProfilingDiffEngine:
    ...
    def _compute_root_cause_analysis(
        ...
        Returns:
            RootCauseFinding 列表
        """
        from npu_mfu_analyzer.analyzers.root_cause_engine import RootCauseSkillEngine
