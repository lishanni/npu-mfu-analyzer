...
from src.skills.v2.base import SkillContext, SkillResult
...
def demo_direct_skill_call():
    """演示直接调用 Skill"""
    from src.skills.v2.skills.compute import MFUSkill
...
def demo_skill_chain():
    """演示技能链执行"""
    from src.skills.v2.engine import SkillEngine
    from src.skills.v2.registry import SkillRegistry
    from src.skills.v2.skills.compute import MFUSkill, BandwidthSkill
