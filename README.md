...
| **AIC 硬件指标分析** | AI Core 微架构级瓶颈诊断：Cube/Vector 利用率、L2 命中率、流水线停顿 |
...
│  └────────┴────────┘    │                                      │
├──────────────────────────┴──────────────────────────────────────┤
│  Skill Engine │ Analyzers │ Roofline │ What-if │ DataValidator │
├─────────────────────────────────────────────────────────────────┤
│  Data Loader │ Hardware Registry │ Pattern Matcher │ Topology  │
├─────────────────────────────────────────────────────────────────┤
│  LLM Backend: Ollama│DeepSeek│OpenAI│Claude│Mock │ ResilientLLM│
└─────────────────────────────────────────────────────────────────┘
```
...
npu-mfu-analyzer/
├── src/
│   ├── agents/           # Multi-Agent 系统 (11 个 Agent)
...
│   │   ├── detailed_operator_agent.py # AIC 级算子分析
